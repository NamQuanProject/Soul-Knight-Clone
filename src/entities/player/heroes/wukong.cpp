...
Wukong::Wukong() : Player() {
    ...
    sf::Image image;
    if (!image.loadFromFile("/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/skill.bmp")) {
...
void Wukong::Initialize() {
    // loadWukongAnimations();
    // weapon1 = new BadPistol();
...
void Wukong::UseSkill() {
    if (mana >= 50) {
        std::cout << "Wukong uses skill!" << std::endl;
        isSkillActive = true;
...
void Wukong::Update(float deltaTime) {
    if (hp <= 0) {
...
void Wukong::loadKnightAnimations() {
    Animation rightStandAnimation;
    std::vector<std::string> framePaths1 = {
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/idle/1.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/idle/2.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/idle/3.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/idle/4.bmp"
    };
    ...
    std::vector<std::string> framePaths2 = {
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/idle/flip_1.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/idle/flip_2.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/idle/flip_3.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/idle/flip_4.bmp"
    };
    ...
    std::vector<std::string> framePaths3 = {
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/run/1.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/run/2.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/run/3.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/run/4.bmp"
    };
    ...
    std::vector<std::string> framePaths4 = {
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/run/flip_1.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/run/flip_2.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/run/flip_3.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/run/flip_4.bmp"
    };
    ...
    std::vector<std::string> framePaths5 = {
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/dead/1.bmp",
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/dead/2.bmp"
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/dead/3.bmp"
        "/Users/quannguyennam/Documents/Projects/Soul Knight Clone/resources/player/wukong/dead/4.bmp"
    };
...
void Wukong::Render(sf::RenderWindow& window) {
    sf::Sprite sprite = animationManager.getCurrentSprite();
...
void Wukong::standRight() {
    animationManager.setAnimation("idle_right");  
}
 
void Wukong::standLeft() {
    animationManager.setAnimation("idle_left"); 
}

void Wukong::Collision(GameObject* gameObject) {
...
void Wukong::SetBeforePosition(Vec a) {
    
}

void Wukong::SetPosition(Vec& newPosition) {
